...
🔗 **Site no ar:** [Acessar o portfólio](https://marlussilvaportifolio.com.br/)
...
- **[Registro.br](https://registro.br/)** para o domínio próprio
...
└── docs/           # Currículo em PDF e prévia do site
```
...
1. Clone o repositório:
   ```bash
   git clone https://github.com/marlustech/my-page-portifolio.git
   ```
...
O site é estático e está hospedado na **Vercel**, com domínio próprio (`marlusulissesportifolio.com.br`) registrado no **Registro.br** e apontado para a Vercel.
